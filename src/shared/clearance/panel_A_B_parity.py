...
def run_regression(args):
    ...
    for head in heads:
        ...
        ax.set_xlabel('True Clearance', fontsize=14, fontweight='bold')
        ax.set_ylabel('Predicted Clearance', fontsize=14, fontweight='bold')
        ...
        # 4) Annotate key percentiles (e.g., median, 75th, 90th)
        for pct in [50, 75, 90]:
            idx = int(len(sorted_pct) * pct / 100) - 1
